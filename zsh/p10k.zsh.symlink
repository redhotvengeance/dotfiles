# Generated by Powerlevel10k configuration wizard on 2024-05-18 at 10:15 PDT.
...
() {
  ...
  function prompt_nix_current_env() {
    if [[ "${CURRENT_NIX_ENV}" == "" ]]; then
      return
    fi

    p10k segment -f 74 -t "(${CURRENT_NIX_ENV})"
  }

  function instant_prompt_nix_current_env() {
    prompt_nix_current_env
  }
